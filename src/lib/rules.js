...
const suffixRules = SUFFIXES.map(({ suffix, weight, minWordLen = 3, minSolutions }) => ({
  ...
  family: 'suffix',
  label: `end in -${suffix}`,
  craving: `words ending in -${suffix}`,
...
const startsRules = STARTS_WITH.map(({ prefix, weight }) => ({
  ...
  craving: `words starting with ${prefix}-`,
...
const specialRules = [
  {
    ...
    craving: 'words with a double letter',
  ...
  },
  {
    ...
    craving: 'words ending in a vowel',
...
const lettersetRules = [
  {
    ...
    craving: 'words with exactly one vowel',
...
const patternRules = [
  {
    ...
    craving: 'words ending in two consonants',
  ...
  },
  {
    ...
    craving: 'words starting with two consonants',
...
const shapeRules = [
  {
    ...
    craving: 'words starting and ending with the same letter',
  ...
  },
  {
    ...
    craving: 'words ending in a double letter',
  ...
  },
  {
    ...
    craving: 'words starting and ending with a vowel',
  ...
  },
  {
    ...
    craving: 'words with three consonants in a row',
    matches: (w) => {
  ...
  },
  {
    ...
    craving: 'words alternating vowels and consonants',
    matches: (w) => {
      if (w.length < 4) return false
  ...
  },
  {
    ...
    craving: 'words with more vowels than consonants',
...
const singleVowelRules = SINGLE_VOWELS.map((v) => ({
  ...
  craving: `words using only the vowel ${v}`,
  matches: (w) => {
    if (w.length < 4) return false
    let seen = false
    for (const c of w) {
